        ...
        >
          ...
          <div className="flex justify-between items-start mb-3">
            <div className="flex-1">
              <span className="inline-block font-semibold text-purple-700 text-sm bg-purple-50 px-2 py-1 rounded">
                {log.accion_display}
              </span>
            </div>
            <code className="bg-gray-100 px-2 py-1 rounded text-xs text-gray-700 ml-2">
              {log.ip}
            </code>
          </div>
